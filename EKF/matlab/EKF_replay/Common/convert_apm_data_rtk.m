...
save ../TestData/APM_RTK/baro_data.mat baro_data;
...
save ../TestData/APM_RTK/imu_data.mat imu_data;
...
save ../TestData/APM_RTK/mag_data.mat mag_data;
...
% set reference point used to set NED origin when GPS2 accuracy is sufficient
...
save ../TestData/APM_RTK/gps_data.mat gps_data;
...
if (exist('RFND','var'))
    ...
    save ../TestData/APM_RTK/rng_data.mat rng_data;
end
...
if (exist('OF','var'))
    ...
    save ../TestData/APM_RTK/flow_data.mat flow_data;
end
...
if (exist('VISO','var'))
    ...
    save ../TestData/APM_RTK/viso_data.mat viso_data;
end

% save data and clear workspace
%clearvars -except baro_data imu_data mag_data GPS2_data rng_data flow_data viso_data out*;
