set(0, 'DefaultFigureColor', 'White','DefaultFigurePaperType','a4letter', 'DefaultAxesColor', 'white', 'DefaultAxesDrawmode', 'fast', 'DefaultAxesFontUnits', 'points', 'DefaultAxesFontSize', 10, 'DefaultAxesFontAngle', 'normal',... 
