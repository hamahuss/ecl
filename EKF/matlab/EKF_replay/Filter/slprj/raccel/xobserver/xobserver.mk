...
MODEL               = xobserver
MODULES             = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c xobserver.c xobserver_capi.c xobserver_data.c xobserver_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE            = xobserver.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Users/husse/Desktop/Asus/ecl/EKF/matlab/EKF_replay/Filter
S_FUNCTIONS         = rtiostream_utils.c sfunwavenet.c eval_wavenet.c
...
MODELLIB                  = xobserverlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = xobserver_ref.rsp
MODELREF_INC_PATH         = 
...
%.obj : $(MATLAB_ROOT)/toolbox/ident/idutils/src/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
%.obj : $(MATLAB_ROOT)/toolbox/ident/idutils/src/%.cpp
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
